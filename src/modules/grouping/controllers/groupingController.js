...
define(['angular'],
    function (angular, jQuery) {
        ...
        var groupingController = function ($scope, $location, $routeParams, groupingService, busyIndicator, $rootScope, $window) {
        ...
        groupingController.$inject = ['$scope', '$location', '$routeParams', 'groupingService', 'busyIndicator', '$rootScope', '$window'];
