...
define(['angular'],
    function (angular, jQuery) {
        var editGroupController = function ($scope, groupingService, $window, $rootScope, busyIndicator) {
            ...
            $scope.filterByKeyword = function (keyword) {
                ...
                if (keyword !== '') {
                    ...
                    angular.forEach($scope.props, function (item) {
                        if (item.property_name.toLowerCase().indexOf(key) !== -1 || item.state_code.toLowerCase().indexOf(key) !== -1 || item.city_name.toLowerCase().indexOf(key) !== -1) {
                            filteredProps.push(item);
                        }
                    });
                    $scope.props = filteredProps;
      ...
      editGroupController.$inject = ['$scope', 'groupingService', '$window', '$rootScope', 'busyIndicator'];
